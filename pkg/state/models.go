...
func (Empty) CurrentHelmValuesPatch() string                { return "" }
...
func (v V0) CurrentHelmValuesPatch() string                { return "" }
...
type V1 struct {
	...
	HelmValuesPatch    string                 `json:"helmValuesPatch,omitempty" yaml:"helmValuesPatch,omitempty" hcl:"helmValuesPatch,omitempty"`
...
func (v VersionedState) CurrentHelmValuesPatch() string {
	if v.V1 != nil {
		return v.V1.HelmValuesPatch
	}
	return ""
}
